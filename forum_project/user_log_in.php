...
<?php
    ...
    if(isLoggedInUser($_SESSION['username'],$_SESSION['password'])){
        ...
        echo'
        <script> 
        myAlert("There is already a logged in user!");
        setTimeout(function() {
  ...
  <div class="row">
    ...
    <div class="p-4" style="width: 60%;" id="loginForm">
        <h3 class="text-center">Login</h3>
        <form action="user_log_in_server.php" method="POST" onsubmit="return checkEmptyFields()">
            <div class="mb-3">
            ...
            <script>
                ...
                var password = document.getElementById("password").value.trim();
                    if(username==="" || password===""){
                        myAlert("You must insert non-empty values on both fields!");
                        return false;
                    }
                    return true;
                }
